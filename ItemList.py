...
item_table: dict[str, tuple[str, Optional[bool], Optional[int], Optional[dict[str, Any]]]] = {
    ...
    'Bombs (30)':                                      ('Item',     None,  0x0068, {'junk': 0}),
    ...
    'Boss Key (Dodongos Cavern)':                      ('BossKey',  True,  0x00D4, None),
    ...
    'Buy Piece of Heart':               ('Shop',     True,  0x3E, {'object': 0x00BD, 'price': 100}),
    'Buy Wallet':                       ('Shop',     True,  0x85, {'object': 0x00D1, 'price': 100}),
